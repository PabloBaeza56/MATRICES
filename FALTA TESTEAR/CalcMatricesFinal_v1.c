...
double obterner_incognitas_2_x_2(double** matriz, dimensiones medidas, float determinante_maestro, int fila_a, int fila_b){
	...
	double res = calcular_determinante_orden_dos_x_dos(matriz_temporal, medidas) / (float)determinante_maestro;
	return res;
...
void obtener_incognitas_3_X_3(double** matriz, dimensiones medidas){
	...
	for (int t = 0; t < 3; t++){
		...
		double determinante_res = (calcular_determinante_orden_tres_x_tres(matriz_operable_reducida, medidasReducidas)) / (float)determinante_3_x_3_matriz_original;
...
void obtener_incognitas_4_X_4(double** matriz, dimensiones medidas){
	...
	for (int numero_columna = 0; numero_columna < medidas.filas; numero_columna++){
		...
		double resultado_incognita = (calcular_determinante_orden_cuatro_x_cuatro(matriz_operable_reducida, medidasReducidas)) /(float)determinante_4_x_4_matriz_original;
